...
class DatasetDownloader(ABC):
    ...
    def __init__(self, raw_root='data/raw', force=False):
    ...
    def download(self):
        ...
        try:
            ...
            raise RuntimeError(f'Failed to download {self.name} from {self.url}. Check your network connection.') from exc
    ...
    def _download_url(self, url, output_path):
        ...
        request = Request(url, headers={'User-Agent': 'colonoscopy-segmentation-reproduction/0.1'})
    ...
    def _verify_archive(self):
        ...
        if actual != self.sha256:
            raise ValueError(f'Checksum mismatch for {self.archive_path}. Expected {self.sha256}, got {actual}.')

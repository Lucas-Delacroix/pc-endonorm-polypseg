...
from data.transforms.robust_style import build_appearance_transforms, build_geometric_transforms, build_normalize_transforms

class ConsistencyViews:

    def __init__(self, image_size, augmentation):

...
def save_debug(path, rgb, norm, clahe, phase, morph, debug):
    panels = [(rgb, 'RGB', None), (norm, 'EndoNorm', None), (clahe, 'CLAHE', None), (debug['illumination_field'], 'illumination', 'magma'), (debug['specular_mask'], 'specular', 'gray'), (phase, 'phase', 'inferno'), (morph, 'morph', 'viridis')]
